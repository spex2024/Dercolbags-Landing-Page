...
export const offerings: Offering[] = [
  {
    ...
    description: "DercolBags Packaging Company Limited produces high-performance Fibre Boxes, Paper Boxes, and Eco-Pouches locally, reducing costs by up to 30%.",
    details:
      "Our local manufacturing hubs convert processed fiber into premium corrugated and fibre boxes, eliminating international logistical friction while supporting regional industrial growth.",
    ...
    tags: ["Fibre Boxes", "Paper Boxes", "Eco-Pouches"],
    learnMoreHref: "/store",
    ctaLabel: "Visit Store",
    heroTitle: "Locally Engineered, Globally Sustainable",
    heroBody:
      "DercolBags Packaging Company Limited converts processed waste into premium fibre packaging, drastically reducing the carbon footprint and cost structure of our partners.",
    featureList: [
      "30% reduction in lead times compared to imports",
      "Custom branded paper boxes and pouches for growing businesses",
