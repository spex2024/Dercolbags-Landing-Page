...
const services = [
   ...
   },
   {
      ...
      description: "A digital waste-to-packaging ecosystem connecting waste generators, waste pickers, recyclers, manufacturers, and businesses for full traceability.",
      icon: Layers,
